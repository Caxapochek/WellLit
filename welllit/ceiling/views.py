...
class MainPage(DataMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        mixin_context = self.get_user_context(title = 'WellLit - монтаж натяжных потолков в Ярославле',
                                              description = 'Сайт компания Welllit. Монтаж натяжных потолков под ключ в Ярославле. Поможем подобрать наилучшее решение именно для вас и качественно реализовать его в ближайшие сроки. Любые размеры, формы и материалы. Доставка, монтаж, гарантия 2 года!',
